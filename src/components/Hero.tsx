        ...
        <main id="home" className="min-h-screen py-36 relative myHero">
            <div className="container-xl relative z-10 h-screen">
                ...
                <div className="flex gap-5 mt-10">
                    <h2 className="cursor-pointer myTransition-ease scale font-bold bg-gradient-to-r from-amber-500 via-purple-500 to-pink-500 w-fit px-8 sm:px-12 text-white rounded-full py-2 hover:shadow-lg shadow-pink-800/60">Ver projetos</h2>
                    <h2 className="cursor-pointer myTransition-ease scale font-bold bg-gradient-to-r from-slate-800 via-indigo-500 to-blue-500/30 w-fit px-8 sm:px-12 text-white rounded-full py-2 hover:shadow-lg shadow-blue-800/60">Sobre</h2>
                </div>
